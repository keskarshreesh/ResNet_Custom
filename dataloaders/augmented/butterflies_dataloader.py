...
train_dataset = datasets.ImageFolder(root='/common/users/skk139/ResNet_Custom/datasets/butterflies/train', transform=transform)
test_dataset = datasets.ImageFolder(root='/common/users/skk139/ResNet_Custom/datasets/butterflies/test', transform=transform)
valid_dataset = datasets.ImageFolder(root='/common/users/skk139/ResNet_Custom/datasets/butterflies/valid', transform=transform)
